...
func init() {
	add(map[string][2]string{
		...
		"fleet.hint":      {"↑↓←→ · enter · n миссии · c чек-ин · C награды · s стратегия · t шаблоны · m рынок · f союзники · o настройки · r · q", "↑↓←→ · enter · n missions · c check-in · C rewards · s strategy · t templates · m market · f allies · o settings · r · q"},
		"fleet.hint_auto": {"↑↓←→ · enter · n миссии · c чек-ин · C награды · s стратегия · t шаблоны · A авто · m рынок · f союзники · o · r · q", "↑↓←→ · enter · n missions · c check-in · C rewards · s strategy · t templates · A auto · m market · f allies · o · r · q"},
		...
		"fleet.notice.ro_claim":             {"только чтение — нет подписанта для сбора наград", "read-only — no signer configured to claim"},
		"fleet.notice.claiming":             {"сбор наград сезона…", "claiming season rewards…"},
